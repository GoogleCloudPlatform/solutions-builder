...
If you haven't set up the GKE cluster by following the [INSTALLATION.md](../INSTALLATION.md), you can initialize GKE cluster via Terraform. This will create the following resources:
- A GKE cluster
